define("libs/ni/sha512",function(require,exports,module){
/*
...
(function (K) {
  function x(b, a, d) {
    ...
    this.setHMACKey = function (a, d, g) {
      ...
      for (a = 0; a <= g; a += 1) {
        u[a] = d[a] ^ 909522486, r[a] = d[a] ^ 1549556828;
      }
  ...
  function E(b, a, d) {
    ...
    for (g = 0; g < a; g += 1) {
      k = b[g >>> 2] >>> 8 * (3 + g % 4 * -1), e += "0123456789abcdef".charAt(k >>> 4 & 15) + "0123456789abcdef".charAt(k & 15);
    }
  ...
  function F(b, a, d) {
    ...
    for (k = 0; k < g; k += 3) {
      for (f = k + 1 < g ? b[k + 1 >>> 2] : 0, c = k + 2 < g ? b[k + 2 >>> 2] : 0, c = (b[k >>> 2] >>> 8 * (3 + k % 4 * -1) & 255) << 16 | (f >>> 8 * (3 + (k + 1) % 4 * -1) & 255) << 8 | c >>> 8 * (3 + (k + 2) % 4 * -1) & 255, f = 0; 4 > f; f += 1) {
        8 * k + 6 * f <= a ? e += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(c >>> 6 * (3 - f) & 63) : e += d.b64Pad;
      }
    }
    ...
    switch (b) {
      ...
      case "TEXT":
        d = function d(b, _d2, c) {
          ...
          c = c || 0;
          p = c >>> 3;
          if ("UTF8" === a) for (r = 3, h = 0; h < b.length; h += 1) {
            for (f = b.charCodeAt(h), n = [], 128 > f ? n.push(f) : 2048 > f ? (n.push(192 | f >>> 6), n.push(128 | f & 63)) : 55296 > f || 57344 <= f ? n.push(224 | f >>> 12, 128 | f >>> 6 & 63, 128 | f & 63) : (h += 1, f = 65536 + ((f & 1023) << 10 | b.charCodeAt(h) & 1023), n.push(240 | f >>> 18, 128 | f >>> 12 & 63, 128 | f >>> 6 & 63, 128 | f & 63)), l = 0; l < n.length; l += 1) {
              q = m + p;

              for (t = q >>> 2; _d2.length <= t;) {
                _d2.push(0);
              }
        ...
        d = function d(a, b, _d3) {
          ...
          for (m = 0; m < a.length; m += 4) {
            ...
            for (h = l = 0; h < p.length; h += 1) {
              n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(p[h]), l |= n << 18 - 6 * h;
            }

            for (h = 0; h < p.length - 1; h += 1) {
              q = c + t;

              for (n = q >>> 2; b.length <= n;) {
                b.push(0);
              }
      ...
      case "BYTES":
        d = function d(a, b, _d4) {
          ...
          for (n = 0; n < a.length; n += 1) {
            c = a.charCodeAt(n), l = n + m, h = l >>> 2, b.length <= h && b.push(0), b[h] |= c << 8 * (3 + l % 4 * -1);
          }

          return {
            value: b,
            binLen: 8 * a.length + _d4
          };
        };
      ...
      case "ARRAYBUFFER":
        ...
        d = function d(a, b, _d5) {
          ...
          for (c = 0; c < a.byteLength; c += 1) {
            h = c + n, m = h >>> 2, b.length <= m && b.push(0), b[m] |= l[c] << 8 * (3 + h % 4 * -1);
          }

          return {
            value: b,
            binLen: 8 * a.byteLength + _d5
          };
        };
  ...
  function B(c, a, d) {
    ...
    for (q = 0; q < t; q += 1) {
      16 > q ? (p = q * y, l = c.length <= p ? 0 : c[p], p = c.length <= p + 1 ? 0 : c[p + 1], w[q] = new F(l, p)) : w[q] = x(z(w[q - 2]), w[q - 7], A(w[q - 15]), w[q - 16]), l = v(h, C(f), D(f, r, m), G[q], w[q]), p = u(B(d), E(d, e, g)), h = m, m = r, r = f, f = u(k, l), k = g, g = e, e = d, d = u(l, p);
    }
